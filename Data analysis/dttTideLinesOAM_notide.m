...
% This script defines the location of the low and high tide fronts using
% the Opening Angle Method (OAM) of Shaw et al (2008).
...
%% TEST PLOTS 1
% figure(111)
% imagesc(dttLowTideSeaAnglesMatrix{125}, [0 180])
% set(gca, 'ydir', 'normal')
% hold on
% contour(dttLowTideSeaAnglesMatrix{125}, [45 45], 'k--', 'linewidth', 2)
% contour(dttLowTideSeaAnglesMatrix{125}, [70 70], 'k-', 'linewidth', 2)
% for ii = 1:size(dttLandEdgeCells, 1)
